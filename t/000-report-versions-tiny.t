...
eval { $v .= pmver('ElasticSearchX::Model','any version') };
eval { $v .= pmver('ElasticSearchX::Model::Document','any version') };
eval { $v .= pmver('ElasticSearchX::Model::Generator','any version') };
